...
var _EncodeCode=function(text){text=text.replace(/&/g,"&amp;");text=text.replace(/</g,"&lt;");text=text.replace(/>/g,"&gt;");text=text.replace(/‘/g,"&lsquo;");text=text.replace(/’/g,"&rsquo;");text=text.replace(/“/g,"&ldquo;");text=text.replace(/”/g,"&rdquo;");text=escapeCharacters(text,"\*_{}[]\\",false);return text;}
...
var _EncodeAmpsAndAngles=function(text){text=text.replace(/&(?!#?[xX]?(?:[0-9a-fA-F]+|\w+);)/g,"&amp;");text=text.replace(/<(?![a-z\/?\$!])/gi,"&lt;");text=text.replace(/‘/g,"&lsquo;");text=text.replace(/’/g,"&rsquo;");text=text.replace(/“/g,"&ldquo;");text=text.replace(/”/g,"&rdquo;");return text;}
