...
Attacklab.wmdBase = function() {
    ...
    _2.undoManager = function(_94, _95) {
        ...
        var _a4 = function(_a5) {
            ...
            if (_a5.ctrlKey || _a5.metaKey) {
                var _a7 = (_a5.charCode || _a5.keyCode);
    ...
    _2.editor = function(_b0, _b1) {
        ...
        var _d0 = function() {
            var _d1 = _6.createImage("../img/wmd/separator.png", 20, 20);
        ...
        var _e0 = function() {
            ...
            _fa.width = "16px";
            _fa.height = "16px";
            _fb.href = "/editing-help";
            _fb.target = "_edithelp";
            _fb.title = "markdown quick reference";
            var _fc = _6.createImage("../img/wmd/help.png");
            _fb.appendChild(_fc);
            _b8.appendChild(_fb);
        };
        var _e1 = function() {
    ...
    _8.doLinkOrImage = function(_151, _152, _153) {
        ...
        if (_151.endTag.length > 1) {
            ...
            var _155 = function(_156) {
                if (_156 != null) {
                    if (_156.indexOf('http://') == -1) {
                        _156 = "http://" + _156;
                    }
                    _156 = _156.replace('http://http://', 'http://');
            ...
            if (_152) {
                _154 = _6.prompt("<p style='margin-top: 0px'><b>Enter the image URL</b></p><p>http://example.com/images/diagram.jpg   \"optional title\"</p><p>Need <a href=\"http://www.google.com/search?q=free+image+hosting\" target=\"_blank\">free image hosting?</a></p>", "http://", _155);
            } else {
                _154 = _6.prompt("<p style='margin-top: 0px'><b>Enter the web address</b></p><p>http://example.com/   \"optional title\"</p>", "http://", _155);
            }
            return true;
        }
    };
    ...
    _8.undo.image = "../img/wmd/undo.png";
    _8.undo.execute = function(_15b) {
        _15b.undo();
    };
    _8.redo = {};
    _8.redo.description = "Redo";
    _8.redo.image = "../img/wmd/redo.png";
